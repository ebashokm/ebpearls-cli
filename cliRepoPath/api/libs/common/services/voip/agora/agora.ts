...
import { AGORA_VOIP_BUNDLE_ID, AGORA_VOIP_KEY_ID, AGORA_VOIP_TEAM_ID } from './constants/agora';
...
export class VoipHelperService {
  ...
  async sendVoipIos(
    ...
    const keyIds = {
      agora: AGORA_VOIP_KEY_ID,
    };
    const teamIds = {
      agora: AGORA_VOIP_TEAM_ID,
    };
    ...
    try {
      ...
      note.topic = AGORA_VOIP_BUNDLE_ID;
