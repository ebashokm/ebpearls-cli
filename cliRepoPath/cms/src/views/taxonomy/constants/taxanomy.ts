...
export const validationSchema = Yup.object().shape({
    ...
    //         return true;
    //     }),
    metaTitle: Yup.string().trim().nullable().min(3).max(30).label('Meta title'),
    metaDescription: Yup.string().trim().nullable().min(3).max(30).label('Meta description'),
    metaKeywords: Yup.string().trim().nullable().min(3).max(30).label('Meta keywords'),
