...
const NavCollapse = ({ menu, level, parentId }: NavCollapseProps) => {
    ...
    const iconSelectedColor = mode === ThemeMode.DARK && drawerOpen ? 'text.primary' : theme.palette.background.paper;
        ...
        <>
            {!isHorizontal ? (
                <>
                    <ListItemButton
                        sx={{
                            color: mode === ThemeMode.DARK ? theme.palette.text.dark : theme.palette.background.paper,
                            zIndex: 1201,
                            borderRadius: open ? '8px 8px 0 0' : `${borderRadius}px`,
                            mb: 0.5,
                            pt: open ? '14px' : '8px',
                            ...
                            ...(drawerOpen &&
                                ...
                                mode !== ThemeMode.DARK && {
                                    ...
                                    '&.Mui-selected': {
                                        ...
                                        '&:hover': { color: iconSelectedColor, bgcolor: alpha(theme.palette.primary.main, 0.5) }
                                    }
                                }),
                                ...
                                sx={{
                                    ...
                                    ...(!drawerOpen &&
                                        level === 1 && {
                                            ...
                                            ...(isSelected && {
                                                bgcolor:
                                                    mode === ThemeMode.DARK ? alpha(theme.palette.secondary.main, 0.25) : 'transparent',
                                                '&:hover': {
                                                    bgcolor:
                                                        mode === ThemeMode.DARK ? alpha(theme.palette.secondary.main, 0.3) : 'transparent'
                                                }
                                            })
                                        })
                                }}
                ...
                >
                    {menuIcon && (
                        <ListItemIcon sx={{ my: 'auto', minWidth: !menu.icon ? 18 : 36, color: 'primary.light' }}>{menuIcon}</ListItemIcon>
                    )}
                    <ListItemText
                        primary={
