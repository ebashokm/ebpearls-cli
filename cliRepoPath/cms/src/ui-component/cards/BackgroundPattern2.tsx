...
import AuthPattern from 'assets/images/auth/login-screen-image.jpg';
// import AuthPatternDark from 'assets/images/auth/login-screen-image.jpg';
...
const BackgroundPattern2 = ({ children }: { children: ReactElement | ReactElement[] }) => {
    ...
    return (
        ...
        >
            ...
            <CardMedia
                component="img"
                sx={{ zIndex: 1, position: 'absolute', bottom: 0, right: 0, width: 1, height: '100%' }}
